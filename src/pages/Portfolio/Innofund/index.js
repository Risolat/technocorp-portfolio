    ...
    <div>
      ...
      <div className="p-[24px]">
        ...
        <div className="flex items-center justify-between">
          <img src={innofund1} alt="adliya" className="w-[45%] h-[45%]" />
          <img src={innofund2} alt="adliya" className="w-[45%] h-[45%]" />
        </div>
        <div className="flex justify-between items-start my-[50px]">
          <div className="flex items-center w-[35%]">
            <span className="w-[42px] h-[3px] rounded bg-[#D9D9D9] mr-[20px]"></span>
        ...
        <div className="flex items-center justify-between">
          <img src={innofund3} alt="adliya" className="w-[45%] h-[45%]" />
          <img src={innofund4} alt="adliya" className="w-[45%] h-[45%]" />
        </div>
