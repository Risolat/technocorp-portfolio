      ...
      <div>
        ...
        <div className="mx-[24px]">
          ...
          <div className="flex flex-col md;flex-row items-center justify-between">
            <img src={fvv1} alt="fvv" className="w-full md:w-[45%] mb-5 h-[45%]" />
            <img src={fvv2} alt="fvv" className="w-full md:w-[45%] h-[45%]" />
          </div>
          <div className="flex flex-col md;flex-row justify-between items-start my-[50px]">
            <div className="flex items-center w-full md:w-[35%] mb-2">
              <span className="w-[42px] h-[3px] rounded bg-[#D9D9D9] mr-[20px]"></span>
          ...
          <div className="flex flex-col md;flex-row items-center justify-between">
            <img src={fvv3} alt="fvv" className="w-full md:w-[45%] mb-5 h-[45%]" />
            <img src={fvv4} alt="fvv" className="w-full md:w-[45%] h-[45%]" />
          </div>
